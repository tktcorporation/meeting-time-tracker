import { Clock, Plus, Users, BarChart3, Sparkles } from 'lucide-react'
	...
	return (
		<div className="flex flex-col items-center justify-center py-16 px-8">
			...
			<div className="relative mb-8">
				...
				<Clock className="w-32 h-32 text-primary relative z-10" strokeWidth={1.5} />
			</div>
			...
			<div className="flex items-center gap-4 mb-12">
				<div className="flex flex-col items-center">
					...
					<span className="text-xs text-muted-foreground">{t('onboarding.step1')}</span>
				</div>
				...
				<div className="flex flex-col items-center">
					...
					<span className="text-xs text-muted-foreground">{t('onboarding.step2')}</span>
				</div>
				<div className="w-12 h-0.5 bg-border" />
				<div className="flex flex-col items-center">
					<div className="w-16 h-16 bg-primary/10 rounded-full flex items-center justify-center mb-2">
					...
					<span className="text-xs text-muted-foreground">{t('onboarding.step3')}</span>
				</div>
			</div>
