import { CheckCircle2, Circle, Play, Edit, Trash2, Save, X, Plus } from 'lucide-react'
 ...
 */
export function MeetingProgress({ items, onItemClick, onItemEdit, onItemDelete, onItemAdd, onAddSample }: MeetingProgressProps) {
	const { t } = useLanguage()
								...
								{editingIndex === index ? (
									...
									<div>
										<div className="flex items-start justify-between">
											...
											{!item.isActive && !isCompleted && onItemEdit && onItemDelete && (
